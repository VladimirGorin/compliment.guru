    ...
    <div className="privacy">
      <div className="section sec1">
        <ul className="list-info">
          <li className="normal-li">Общие положения</li>
          <li className="normal-li">
            ...
            данных, предпринимаемые Забориным Юрием Анатольевичем ИНН
            <br />
            (далее – Оператор).
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">
            ...
            <Link to={"https://compliment.guru"}>https://compliment.guru</Link>
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">Основные права и обязанности Оператора</li>
          <li className="normal-li">3.1. Оператор имеет право:</li>
          <li className="normal-li">
          ...
          <li className="normal-li">3.2. Оператор обязан:</li>
          <li className="normal-li">
          ...
          <li className="normal-li">4.2. Субъекты персональных данных обязаны:</li>
          <li className="normal-li">
          ...
          <li className="normal-li">5.1. Фамилия, имя, отчество.</li>
          <li className="normal-li">5.2. Электронный адрес.</li>
          <li className="normal-li">
            5.3. Также на сайте происходит сбор и обработка обезличенных данных
            о посетителях (в т.ч. файлов «cookie») с помощью сервисов интернет
          ...
          <li className="normal-li">
            5.7.1 Согласие на обработку данных, разрешенных для распространения,
          ...
          <li className="normal-li">
            ...
            субъекта персональных данных, а также нотариально заверенную копию
          ...
          <li className="normal-li">
            ...
            материалам, содержащимся на веб-сайте https://compliment.guru
          </li>
          <li className="normal-li">
            7.2. Также Оператор имеет право направлять Пользователю уведомления
            о новых продуктах и услугах, специальных предложениях и различных
            событиях. Пользователь сможет отказаться от получения информационных
            сообщений, направив Оператору письмо на адрес электронной почты
            support@https://compliment.guru с пометкой «Отказ от уведомлений о
          ...
          <li className="normal-li">- уставные документы Оператора;</li>
          <li className="normal-li">
          ...
          <li className="normal-li">
            ...
            Оператора support@compliment.guru с пометкой «Актуализация
            персональных данных».
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">
            ...
            support@compliment.guru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">Трансграничная передача персональных данных</li>
          <li className="normal-li">
          ...
          <li className="normal-li">
            13.1. Конфиденциальность персональных данных
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">Заключительные положения</li>
          <li className="normal-li">
            ...
            <a href="mailto:support@compliment.guru">support@compliment.guru</a>
          </li>
          <li className="normal-li">
          ...
          <li className="normal-li">
            ...
            <Link to="https://compliment.guru/privacy-policy/">
              https://compliment.guru/privacy-policy/
            </Link>
          </li>
        </ul>
      </div>
