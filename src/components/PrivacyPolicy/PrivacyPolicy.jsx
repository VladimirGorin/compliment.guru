    ...
    <div className="privacy">
      <div className="section sec1">
        <ul className="list-info">
          ...
          <li class="normal-li">Основные права и обязанности Оператора</li>
          <li class="normal-li">3.1. Оператор имеет право:</li>
          <li class="normal-li">
          ...
          <li class="normal-li">3.2. Оператор обязан:</li>
          <li class="normal-li">
          ...
          <li class="normal-li">4.2. Субъекты персональных данных обязаны:</li>
          <li class="normal-li">
          ...
          <li class="normal-li">5.1. Фамилия, имя, отчество.</li>
          <li class="normal-li">5.2. Электронный адрес.</li>
          <li class="normal-li">
          ...
          <li class="normal-li">- уставные документы Оператора;</li>
          <li class="normal-li">
          ...
          <li class="normal-li">Трансграничная передача персональных данных</li>
          <li class="normal-li">
          ...
          <li class="normal-li">Заключительные положения</li>
          <li class="normal-li">
